...
export class SurfaceItemUtil {
    ...
    public static isAutonomous(surfaceItem: SurfaceItem | null): surfaceItem is SurfaceItem & Autonomous {
        return surfaceItem !== null && 'findPath' in surfaceItem && typeof surfaceItem.findPath === 'function';
    }
}
